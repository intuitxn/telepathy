...
[RRSI candidate review](docs/designs/rrsi.md) provides an offline, evidence-based admission gate for proposed harness revisions. Automated recursive evaluation and promotion are not running in the resident node.
